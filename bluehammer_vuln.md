...
This exploit was found by a cybersecurity researched that goes by "Nightmade Ecplise", who found an exploit that abuses Defenders update process due to it using shadow volume copies of the file system when an opererstional lock executes. This allows a non-privileged user to escalate their privilege to NT AUTHORITY\SYSTEM.
